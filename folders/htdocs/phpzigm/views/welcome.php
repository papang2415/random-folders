...
<a href="#signupmodal" class="trigger-btn btn btn-outline-secondary float-right" data-toggle="modal">SignUp</a>

<a href="#loginmodal" class="trigger-btn btn btn-outline-secondary float-right ml-2" data-toggle="modal">Login</a>

<a href="admin.php" class=" btn btn-outline-secondary float-right ml-2">Admin</a>
...
<div class="jumbotron text-center"s>
  <h1>Zigmmmmmmmmmmmmm</h1>
  <p>DADADADADA</p> 
</div>
